...
**Status (2026-09-17, codec 1, Android): works, including delivery between two phones.** It is
...
- `host.statement.submit` — **Retracted, a probe bug:** Not measured: sonde's spend gate refused it (the resolved genesis was not in its allowlist). Fixed in sonde on 2026-09-19. The run said: REFUSED: genesis 0xd6eec261… is not in SPEND_ALLOWED_GENESIS. Add it to product.mjs only after confirming it is a chain you are willing to spend on.
